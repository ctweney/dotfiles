...
Chris's OSX / Ubuntu dotfiles. Fork of [Ben Alman's dotfiles](https://github.com/cowboy/dotfiles) 
...
* Font installation via [init/10_osx_fonts.sh](init/10_osx_fonts.sh) script
